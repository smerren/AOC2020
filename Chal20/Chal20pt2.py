# Part 2 I needed a lot of help, the hack in part 1 did not prepare me for this:
# https://gist.github.com/sciyoshi/4a297cd965baad369f5f544029a10dbc
# I've learnt a LOT from networkx's Graph class.
...
for tiledata in open("input20.txt").read().strip().split("\n\n"):
